...
from model import BERT_RNN_ENCODER, CNN_ENCODER
    ...
    for step, data in enumerate(dataloader, 0):
        ...
        if text_encoder_type == "rnn":
            torch.nn.utils.clip_grad_norm(
                nlp_model.parameters(), cfg.TRAIN.RNN_GRAD_CLIP
            )
        optimizer.step()
        ...
        if step % UPDATE_INTERVAL == 0:
            ...
            s_cur_loss0 = s_loss0.item()
            s_cur_loss1 = s_loss1.item()
        ...
        for epoch in range(start_epoch, cfg.TRAIN.MAX_EPOCH):
            ...
            if len(dataloader_val) > 0:
                ...
                print(
                    ...
                    "{:5.5f} {:5.5f} | lr {:.8f}|".format(epoch, s_loss, w_loss, lr)
                )
            print("-" * 89)
